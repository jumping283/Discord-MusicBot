module.exports = {
  ...
  Port: 7665, //Which port website gonna be hosted
  SupportServer: "https://discord.gg/123", // Support Server Link
  ...
  CookieSecret: "7838737377828828819199292 is cute", // A cookie for you, cookie for me. make sure you change this value!
  IconURL:
  ...
  Website: process.env.Website || "http://69.164.195.223:7665/", // Website where it is hosted at includes http or https || Use "0.0.0.0" if you using Heroku || Do not include /api/callback. Just the website url. I.e. "https://foo.bar"
  // If you get invalid oauth, make sure on the discord developer page you set the oauth url to something like: https://example.com/api/callback.

  Presence: {
    status: "online", // You can show online, idle, and dnd
    name: "alexander dunn in jail - cleveland news", // The message shown
    type: "WATCHING", // PLAYING, WATCHING, LISTENING, STREAMING
  },

  // You need a lavalink server for this bot to work!!!!
  // Lavalink server; public lavalink -> git clone -b v5 https://github.com/SudhanPlayz/Discord-MusicBot.git; create one yourself -> https://darrennathanael.com/post/how-to-lavalink
  Lavalink: {
